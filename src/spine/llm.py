...
async def stream_chat(
    ...
    *,
    ...
    deltas as they arrive. OpenAI-compatible SSE: lines 'data: {json}',
    terminator 'data: [DONE]'. Empty/None deltas are skipped. Caller's
    client is used and not closed; otherwise one is created per call.
    Non-2xx raises httpx.HTTPStatusError before any yield."""
